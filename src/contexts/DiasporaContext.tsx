...
export const diasporaTranslations: Record<DiasporaKey, {
  ...
  cn: {
    nav: { consultants: "顾问", organizations: "组织", businesses: "商家", groups: "WA 群组", events: "活动", map: "地图", profile: "我的", login: "登录", signup: "注册", more: "更多", dashboard: "控制台", logout: "退出", media: "媒体", vblogger: "V/博主", registerDiaspora: "注册社群", registerDiasporaDesc: "请求您的社群", selectDiaspora: "选择社群", selectCountry: "选择国家", allCountries: "所有国家" },
  ...
  ph: {
    nav: { consultants: "Consultants", organizations: "Organisasyon", businesses: "Negosyo", groups: "WA Groups", events: "Mga Event", map: "Mapa", profile: "Profile", login: "Login", signup: "Sign Up", more: "Higit Pa", dashboard: "Dashboard", logout: "Mag-logout", media: "Midya", vblogger: "V/Blogger", registerDiaspora: "Magparehistro ng Diaspora", registerDiasporaDesc: "Hilingin ang iyong komunidad", selectDiaspora: "Pumili ng Diaspora", selectCountry: "Pumili ng Bansa", allCountries: "Lahat ng Bansa" },
