...
const plans = [
  {
    ...
    features: ["Danışman arama", "Dernek profilleri görüntüleme", "Etkinlik takibi", "AI Twin ön görüşme (3/ay)"],
    cta: "Ücretsiz Başla",
    featured: false,
  },
  {
    ...
    features: ["Micro site oluşturma", "AI Twin entegrasyonu", "WhatsApp CTA", "Etkinlik düzenleme", "Öncelikli listeleme", "Analitik dashboard"],
    cta: "Pro'ya Geç",
    featured: true,
  },
  {
    ...
    price: "€199",
    period: "/ay",
    desc: "Dernekler ve kurumlar için",
    features: ["Sınırsız danışman profili", "Kurumsal dashboard", "Etkinlik yönetimi", "Bilet satışı", "API erişimi", "Özel destek"],
    cta: "İletişime Geç",
    featured: false,
  },
];
